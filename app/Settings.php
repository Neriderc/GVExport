...
class Settings
{
    ...
    public function __construct($tree = null){
        ...
        $this->defaultSettings['click_action_fam_options'] = [0 => 'Open family page', 10 => 'Add a child', 20 => 'Add to list of families to highlight', 50 => 'Change family members', 30 => 'Show menu',40 => 'Do nothing'];
